...
local function MakeDataCopy(a,b,x) local t=util.table.deepcopy(data.raw[a][b]) if(x)then table.deepmerge(t,x) end return t end
...
local rvtint={scale=1/3,shift={0.03125/3,-0.5/3},tint={r=1,g=1,b=1,a=0}}
local r=ExtendDataCopy("radar","radar",{name="warptorio-invisradar",
	icons={{icon="__base__/graphics/icons/radar.png",tint=rtint}},integration_patch=rvtint,pictures={layers={rvtint,rvtint}}},true,{energy_per_nearby_scan="10kJ",energy_per_sector="200kJ",energy_usage="1kW", icon=false,
...
local t=ExtendDataCopy("container","wooden-chest",{name="warptorio-lootchest",inventory_size=8,
	...
	picture={layers={ [1]={tint=rtint}}}},true,{icon=false,minable={mining_time=0.1}})
...
local t=ExtendDataCopy("container","wooden-chest",{name="warptorio-carebear-chest",inventory_size=99,
	icons={{icon="__base__/graphics/icons/wooden-chest.png",tint=rtint}},
	picture={layers={ [1]={tint=rtint}}}},true,{icon=false,minable={mining_time=10}})
...
ExtendDataCopy("recipe","uranium-fuel-cell",{name="warptorio-warponium-fuel-cell",enabled=false,results={{type="item", name="warptorio-warponium-fuel-cell", amount=1}}},false,
...
ExtendDataCopy("item","nuclear-fuel",{name="warptorio-warponium-fuel",fuel_category="chemical",
	...
	icon_size=64,icons={ {icon="__base__/graphics/icons/nuclear-fuel.png",tint={r=1,g=0.2,b=1,a=0.8}}}},false,{icon=false})

ExtendDataCopy("recipe","nuclear-fuel",{name="warptorio-warponium-fuel",enabled=false,results={{type="item", name="warptorio-warponium-fuel", amount=1}}},false,
...
local t=ExtendDataCopy("reactor","nuclear-reactor",{name="warptorio-reactor",max_health=5000,neighbour_bonus=12,consumption="160MW",
	energy_source={fuel_categories={"warp"}},heat_buffer={specific_heat="1MJ",max_temperature=1000}, light={ intensity=10, size=9.9, shift={0.0,0.0}, color={r=1.0,g=0.0,b=0.0} },
	...
	picture={layers={
		[1]={ tint={r=0.8,g=0.8,b=1,a=1}}}}},true)
...
ExtendTech(t,{name="warptorio-warpmodule",unit={count=3000,time=5}, prerequisites={"warptorio-reactor-8","space-science-pack","efficiency-module-3"},
...
data:extend{{type="recipe",results={{type="item", name="warptorio-warpmodule", amount=1}},name="warptorio-warpmodule",enabled=false,energy_required=60,
	ingredients={{type="item", name="speed-module-3", amount=50},{type="item", name="productivity-module-3", amount=50},{type="item", name="efficiency-module-3", amount=50},{type="item", name="advanced-circuit", amount=200},{type="item", name="processing-unit", amount=200},{type="item", name="low-density-structure", amount=10}}}}
...
local t={type="technology",upgrade=true,icon_size=128,icons={
	{icon="__base__/graphics/technology/nuclear-power.png",tint={r=0.3,g=0.3,b=1,a=1},priority="low",icon_mipmaps=4,icon_size=256},
	{icon="__base__/graphics/technology/advanced-circuit.png",tint={r=0.7,g=0.7,b=1,a=1},scale=0.5,shift={32,32},priority="high",icon_mipmaps=4,icon_size=256}
}}
...
local t={type="technology",upgrade=true,icon_size=128,icons={
	{icon="__base__/graphics/technology/nuclear-power.png",tint={r=0.3,g=0.3,b=1,a=1},priority="low",icon_mipmaps=4,icon_size=256},
	{icon="__base__/graphics/technology/processing-unit.png",tint={r=0.7,g=0.7,b=1,a=1},scale=0.5,shift={32,32},priority="high",icon_mipmaps=4,icon_size=256}
}}
...
local t={type="technology",upgrade=true,icon_size=128,icons={
	{icon="__base__/graphics/technology/nuclear-power.png",tint={r=0.3,g=0.3,b=1,a=1},priority="low",icon_mipmaps=4,icon_size=256},
	{icon="__warptorioSA__/graphics/technology/earth.png",tint={r=0.8,g=0.8,b=1,a=1},scale=0.5,shift={32,32},priority="high"}
}, localised_description={"technology-description.warptorio-reactor-8"} }
ExtendTech(t,{name="warptorio-reactor-8",unit={count=1000,time=30}, prerequisites={"warptorio-reactor-7","warptorio-charting","warptorio-accelerator","warptorio-stabilizer","warptorio-kovarex"}}, {red=1,green=1,black=1,blue=1,purple=1,yellow=1}) -- steering
...
local t={type="technology",upgrade=true,icon_size=128,icons={
	{icon="__warptorioSA__/graphics/technology/earth.png",tint={r=0.8,g=0.8,b=1,a=1},priority="low"}
}}
...
local t=ExtendDataCopy("heat-pipe","heat-pipe",{name="warptorio-heatpipe",connection_sprites=pipe_sprites,heat_glow_sprites=pipe_sprites,
	...
	max_transfer="5GW",
	specific_heat="1MJ",
	icon_size=64,icons={ {icon="__base__/graphics/icons/heat-pipe.png",tint={r=0.3,g=0.3,b=1,a=1}} }
})]]

local pipe_icon={ {icon="__base__/graphics/icons/heat-pipe.png",tint={r=0.3,g=0.3,b=1,a=1}} }
local t=ExtendDataCopy("recipe","heat-pipe",{name="warptorio-heatpipe",results={{"warptorio-heatpipe",1}},ingredients={{"processing-unit",200},{"heat-pipe",50}}, enabled=false,energy_required=30})
...
local t={type="technology",upgrade=true,icon_size=64,icons={ {icon="__base__/graphics/technology/steel-axe.png",tint={r=0.3,g=0.3,b=1,a=1}} },
...
local t={type="technology",upgrade=true,icon_size=128,icons={ {icon="__base__/graphics/technology/inserter-capacity.png",tint={r=0.3,g=0.3,b=1,a=1},icon_mipmaps=4,icon_size=256} },
	effects={ {type="inserter-stack-size-bonus",modifier=1}, {type="inserter-stack-size-bonus",modifier=1}} }
...
local t={type="technology",upgrade=true,icons={
	{icon="__warptorioSA__/graphics/technology/earth.png",tint={r=0.7,g=0.7,b=1,a=1},shift={0,0},scale=0.375,priority="medium",icon_size=128},
	{icon="__base__/graphics/technology/steel-axe.png",tint={r=0.3,g=0.3,b=1,a=1},priority="low",icon_size=64,scale=0.5}},
	effects={
...
local t={type="technology",upgrade=true,icon_size=128,icons={
	{icon="__base__/graphics/technology/exoskeleton-equipment.png",tint={r=0.3,g=0.3,b=1,a=1},icon_mipmaps=4,icon_size=256}}, effects={
...
ExtendTech(t,{name="warptorio-factory-0",unit={count=80,time=20}, prerequisites={"automation","warptorio-platform-size-1"}, upgrade=false,
	...
	localised_description={"technology-description.warptorio-factory-floor"}},{red=1})
...
ExtendTech(t,{name="warptorio-boiler-0",unit={count=100,time=30}, prerequisites={"steel-processing","warptorio-harvester-floor"},upgrade=false,
	...
	localised_description={"technology-description.warptorio-boiler-floor"}}, {red=1})
...
local t={type="technology",upgrade=false,icon_size=128,icons={
	{icon="__base__/graphics/technology/logistics-1.png",tint={r=0.3,g=0.3,b=1,a=1},priority="low",icon_mipmaps=4,icon_size=256},
	{icon="__warptorioSA__/graphics/technology/earth.png",tint={r=0.8,g=0.8,b=1,a=1},scale=1,shift={32,32},priority="high"}
...
ExtendTech(t,{name="warptorio-energy-3",unit={count=150,time=30}, prerequisites={"warptorio-energy-2","advanced-circuit"}}, {red=1,green=1})
ExtendTech(t,{name="warptorio-energy-4",unit={count=200,time=35}, prerequisites={"warptorio-energy-3","electric-energy-distribution-2","processing-unit"}}, {red=1,green=1,blue=1})
...
ExtendTech(t,{name="warptorio-teleporter-2",unit={count=30,time=20}, prerequisites={"warptorio-teleporter-1","advanced-circuit"}}, {red=2,green=2})
ExtendTech(t,{name="warptorio-teleporter-3",unit={count=30,time=20}, prerequisites={"warptorio-teleporter-2","electric-energy-distribution-2","processing-unit"}}, {red=2,green=2,blue=1})
...
local t=ExtendDataCopy("beacon","beacon",{name="warptorio-beacon-1",supply_area_distance=16,module_specification={module_slots=1},
	...
	distribution_effectivity=1},true)
for i=2,10,1 do local xt=util.table.deepcopy(t) xt.name="warptorio-beacon-"..i xt.supply_area_distance=math.min(16+8*i,64) xt.module_specification.module_slots=i data:extend{xt} end
...
local t=ExtendDataCopy("recipe","power-armor-mk2",{name="warptorio-armor",enabled=false,ingredients={{"power-armor-mk2",5},{"power-armor",5},{"modular-armor",5},{"heavy-armor",5},{"light-armor",5}},results={{"warptorio-armor",1}}})
...
local t={type="technology",upgrade=true,icon_size=128,icons={
	...
	{icon="__warptorioSA__/graphics/technology/earth.png",tint={r=0.8,g=0.8,b=1,a=0.9},priority="medium",shift={32,32},scale=1}}}
